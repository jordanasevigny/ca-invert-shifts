...
* ‘ca-invert-shits/scripts/load_calcofi_review.R’
  * Input:  ‘ca-invert-shits/data/CalCOFI Coding Form (Responses).xlsx’, Output: ‘ca-invert-shits/processed_data/calcofi_review_data_clean.csv’, Method: Stacks the individual extensions per calcofi excerpt vertically and renames columns to match shared lab review columns.
